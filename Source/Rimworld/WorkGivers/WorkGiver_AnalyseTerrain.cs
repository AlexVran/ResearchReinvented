...
namespace PeteTimesSix.ResearchReinvented.Rimworld.WorkGivers
{
	...
	public class WorkGiver_AnalyseTerrain : WorkGiver_Scanner
	{
		...
		private static IEnumerable<ResearchOpportunity> MatchingOpportunities => ResearchOpportunityManager.Instance.Execution
			.QueryCurrent(ActivityHandlerIds.AnalysisFieldTerrain);
        ...
        private static IReadOnlyList<ResearchOpportunity> FilterCacheFor(TerrainDef terrainDef, Pawn pawn)
        {
            return ResearchOpportunityManager.Instance.Execution.QueryForMap(pawn.MapHeld, ActivityHandlerIds.AnalysisFieldTerrain, terrainDef);
        }
    }
}
